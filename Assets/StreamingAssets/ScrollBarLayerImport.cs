...
namespace UGUIAssembler
{
    public class ScrollBarLayerImport : ILayerImport
    {
        ...
        public override GameObject CreateTemplate()
        {
            ...
            UGUIAssembler.PSDImporterUtility.SetNormalAnchor(AnchoType.XStretch | AnchoType.YStretch, scollbar.GetComponent<RectTransform>(), sliding_Area.transform as RectTransform);

            handle.transform.SetParent(sliding_Area.transform, false);
            UGUIAssembler.PSDImporterUtility.SetNormalAnchor(AnchoType.XCenter | AnchoType.XCenter, sliding_Area.GetComponent<RectTransform>(), handle.transform as RectTransform);
